...
auto BPlusTreePage::GetIndex() -> int { return index_; }
void BPlusTreePage::SetIndex(int index) { index_ = index; }

auto BPlusTreePage::IsOverFlow() -> bool {
  if (IsLeafPage()) {
...
auto BPlusTreePage::IsUnderFlow() -> bool { return GetSize() < GetMinSize(); }

auto BPlusTreePage::WillOverFlow() -> bool {
  if (IsLeafPage()) {
...
auto BPlusTreePage::WillUnderFlow() -> bool { return size_ == GetMinSize(); }
